...
def mesa_ext():
    ...
    return Extension("opendr.contexts.ctx_mesa",
                     ['opendr/contexts/ctx_mesa.pyx'] if have_cython else ['opendr/contexts/ctx_mesa.c'],
                     language="c",
...
def mac_ext():
    return Extension("opendr.contexts.ctx_mac",
                     ['opendr/contexts/ctx_mac.pyx', 'opendr/contexts/ctx_mac_internal.c'] if have_cython else [
                         'opendr/contexts/ctx_mac.c', 'opendr/contexts/ctx_mac_internal.c'],
                     language="c",
